...
def simple_periodic_icc(bus):
    ...
    audiocurrentmediamode = can.Message(arbitration_id=0x2F2, data=[0x0A, 0x12, 0x11, 0x0E, 0x09, 0x49, 0x45, 0x01], is_extended_id=False)
    ...
    msg = (
        acm, fdimwake, fdimtext, hvac, audiocurrentmediamode
        )
